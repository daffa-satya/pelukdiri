...
/**
 * Legacy Intervention Overlay UI. 
 * Kept for reference or rollback as per project requirements.
 */
@Composable
fun InterventionOverlayScreenLegacy(
    ...
    InterventionOverlayContentLegacy(
        state = uiState,
...
@Composable
fun InterventionOverlayContentLegacy(
...
@Composable
private fun ActiveQuestionContentLegacy(
    state: InterventionUiState.QuestionActive,
    onAnswerChanged: (String) -> Unit,
    onSubmitAnswer: () -> Unit,
    onBypass: () -> Unit
...
@Composable
private fun InterventionOverlayContentLegacyPreview() {
    PELUKDIRITheme {
        InterventionOverlayContentLegacy(
            state = InterventionUiState.QuestionActive(
